...
const Register = () => {
  return (
    <Authlayout>
      <div className="flex flex-col gap-7 lg:gap-4 2xl:gap-7">
        <div className="flex flex-col items-center lg:items-start gap-2">
          <p className="text-primary font-semibold text-xl md:text-2xl 2xl:text-3xl">
            Create an Account
          </p>
        ...
        <form className="flex flex-col gap-5 lg:gap-3 2xl:gap-5 w-full px-2 lg:p-0">
          <div className="flex flex-col gap-5 lg:gap-3 2xl:gap-5">
          ...
          <button className="bg-primary rounded-3xl text-xs md:text-sm 2xl:text-base py-2 2xl:py-3 w-full text-white cursor-pointer mt-4">
            Continue
          </button>
        </form>
