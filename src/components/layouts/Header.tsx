...
const Header = () => {
  return (
    <div className="flex bg-white w-full max-h-[70px] h-[70px] shadow">
        ...
        <div className="flex items-center gap-2 lg:gap-3">
          <div className="bg-[#FAFAFA] rounded-full">
            <div className="p-2.5 md:px-3 px-2 relative">
              ...
              <div className="bg-[#F74A4A] absolute top-1.5 right-1 rounded-full flex items-center justify-center text-xs text-white">
