    ...
    <Authlayout>
      ...
      <form className="flex flex-col gap-10 w-full px-2 lg:p-0">
        <div className="flex flex-col gap-1">
          <label htmlFor="email" className="text-primary text-sm lg:text-base">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link
              to={"/forgot-password"}
              className="text-tertiary text-xs lg:text-sm text-right"
            >
              Forgot Password
            </Link>
          </div>
        ...
        <button
          onClick={handleLogin}
          className="bg-primary rounded-3xl py-2 md:py-3 w-full text-white cursor-pointer"
        >
          Login
        </button>
      </form>
